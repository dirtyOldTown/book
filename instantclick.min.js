...
var InstantClick = function(document, location) {
    ...
    function changePage(title, body, newUrl, scrollY) {
      ...
      */
      ...
      if ($isChromeForIOS && document.title == title) {
         ...
         *
         * 2. Will not set the title if itвЂ™s identical when trimmed, so
      ...
      // Real event, useful for combining userscripts, but only for that so itвЂ™s undocumented.
    ...
    function mousedown(e) {
      if ($lastTouchTimestamp > (+new Date - 500)) {
        return // Otherwise, click doesnвЂ™t fire
      }
    ...
    function display(url) {
      ...
      if ($preloadTimer || !$isPreloading) {
        /* $preloadTimer:
           Happens when thereвЂ™s a delay before preloading and that delay
           hasn't expired (preloading didn't kick in).
  
           !$isPreloading:
           A link has been clicked, and preloading hasnвЂ™t been initiated.
           It happens with touch devices when a user taps *near* the link,
           Safari/Chrome will trigger mousedown, mouseover, click (and others),
           but when that happens we ignore mousedown/mouseover (otherwise click
           doesnвЂ™t fire). Maybe thereвЂ™s a way to make the click event fire, but
           thatвЂ™s not worth it as mousedown/over happen just 1ms before click
           in this situation.
      ...
      if ($isWaitingForCompletion) {
        /* The user clicked on a link while a page was preloading. Either on
           ...
           might have gone wrong (or he could have double clicked, we donвЂ™t
    ...
    var bar = function() {
      ...
      function updatePositionAndScale() {
        /* Adapted from code by Sam Stephenson and Mislav MarohniД‡
